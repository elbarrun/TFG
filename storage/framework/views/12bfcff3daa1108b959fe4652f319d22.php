...
<div class="container my-5">
    <div class="row justify-content-center">
        <div class="col-12 col-md-8"><div data-aos="fade-down">
            ...
            <form method="POST" action="<?php echo e(route('tacticas.store')); ?>" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\Users\ikero\PHPStorm\Workspace\ostias-copia\resources\views/tactica/create_tactica.blade.php ENDPATH**/ ?>