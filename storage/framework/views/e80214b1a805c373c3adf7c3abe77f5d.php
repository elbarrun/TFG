        ...
        <div class="container-fluid">
            <div class="row d-flex flex-row align-items-start flex-column-reverse flex-md-row">
                ...
                <div class="col-12 col-md-4 order-first">
                    ...
                    <a href="<?php echo e(url('equipos')); ?>" class="btn btn-primary-lan carta-team text-white">Ver todos los equipos</a>
                </div>
                <div class="col-12 col-md-7 order-last">
                    <picture>
                        <img src="<?php echo e(asset('img/segunda.jpg')); ?>" alt="Equipo con sus integrantes del segunda" class="img-fluid w-100 h-100">
                    </picture>
                </div>
            </div>
        </div>
        ...
        <div class="container-fluid">
            <div class="row d-flex flex-row align-items-start flex-column-reverse flex-md-row">
                ...
                <div class="col-12 col-md-4 order-first order-md-last">
                    ...
                    <a href="<?php echo e(url('noticias')); ?>" class="btn btn-primary-lan carta-team text-white">Ver más noticias</a>
                </div>
                <div class="col-12 col-md-7 order-last order-md-first">
                    <picture>
                        <img src="<?php echo e(asset('img/news.jpg')); ?>" alt="Un plato con cubiertos y a su derecha un chuletón" class="img-fluid w-100 h-100">
                    </picture>
                </div>
            </div>
        </div>
    ...
    <div data-aos="fade-up"
        ...
        <div class="row mt-5" mt-5>
            <div class="col-3 justify-content-center align-items-center">
                <img src="<?php echo e(asset('img/codecar.jpg')); ?>" class="img-fluid slide-right">
            </div>
            <div class="col-3 justify-content-center align-items-center">
                <img src="<?php echo e(asset('img/toten.jpg')); ?>" class="img-fluid">
            </div>
            <div class="col-3 justify-content-center align-items-center">
                <img src="<?php echo e(asset('img/tornasol.jpg')); ?>" class="img-fluid">
            </div>
            <div class="col-3">
                <img src="<?php echo e(asset('img/frb.jpg')); ?>" class="img-fluid">
            </div>
        </div>
    </div>
</div>
...
<?php /**PATH C:\Users\ikero\PHPStorm\Workspace\ostias-copia\resources\views/layout/public.blade.php ENDPATH**/ ?>